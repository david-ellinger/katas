...
Button(root, font="arial 10 bold", text="RESULT", padx=2, bg="LightGray", command=parse_mode).place(x=60, y=150)
Button(root, font="arial 10 bold", text="RESET", width=6, padx=2, bg="LimeGreen", command=reset).place(x=80, y=190)
Button(root, font="arial 10 bold", text="EXIT", width=6, padx=2, bg="OrangeRed", command=exit).place(x=180, y=190)
